...
/**-----定义公共变量------**/
var mAjaxUrl = "../VipAjax/IntegralDetail";
...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        myJsVal += " <li onclick=\"window.location.href=\'../Vip/InExDetail?INID=" + dataPage.IntegralID + "\'\">";
        myJsVal += " <div class=\"balance-item-left\">";
        myJsVal += "     <div>";
        myJsVal += "         <b>" + dataPage.InExMemo + "</b>";
        myJsVal += "     </div>";
        myJsVal += "     <div>";
        myJsVal += "         当前积分: " + dataPage.CurrentBalance + "";
        myJsVal += "     </div>";
        myJsVal += " </div>";
