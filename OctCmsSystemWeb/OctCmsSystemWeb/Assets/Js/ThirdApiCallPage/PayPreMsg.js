...
//AjaxURL
var mAjaxUrl = "../ThirdApiCall/PayPreMsg";
...
var searchContent = function () {
    ...
    var PayPreID_se = $("#PayPreID_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "PayPreID": PayPreID_se, "UserKeyID": UserKeyID_se, "OrderID": OrderID_se,
        "BillNumber": BillNumber_se, "OrderIDArr": OrderIDArr_se, "OrderPrice": OrderPrice_se, "PayType": PayType_se, "IsPaySuccess": IsPaySuccess_se, "WriteDate": WriteDate_se
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += " <tr>";
        myJsVal += " <td>" + indexDataPage.PayPreID + "</td>";
        ...
        myJsVal += " <td>" + indexDataPage.OrderIDArr + "</td>";
        myJsVal += " <td>" + indexDataPage.OrderPrice + "</td>";
        myJsVal += " <td>" + indexDataPageExtra.PayTypeName + "(" + indexDataPage.PayType + ")</td>";
        myJsVal += " <td>" + indexDataPageExtra.IsPaySuccessName + "</td>";
        myJsVal += " <td>";
 ...
 */
function delPayPreMsgMonthAgo(pMonthNumAgo) {
