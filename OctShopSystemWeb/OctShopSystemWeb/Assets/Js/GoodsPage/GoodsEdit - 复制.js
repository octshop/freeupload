...
function setValToForm(pJsonInitMsg) {
    ...
    //分销
    if (_gooGoodsMsg.IsDistri == "true") {
        $("#IsDistri").prop("checked", true);
        $("#DistriMoney").val(_gooGoodsMsg.DistriMoney);
    }
...
function saveGoodsMsg() {
    ...
    for (var i = 0; i < _nameGoodsPropArr.length; i++) {
        ...
        var _goodsPropValue = $(_nameGoodsPropArr[i]).val().trim()
