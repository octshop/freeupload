...
function jsonToXhtml(pJsonObject) {
    ...
    var myJsVal = "";    //循环构造    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";        myJsVal += "  <td><input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.AcJoinID + "\" />";        myJsVal += "<input type=\"hidden\" name=\"ActivityIDArr\" value=\"" + indexDataPage.ActivityID + "\" />";        myJsVal += "<input type=\"hidden\" name=\"BuyerUserIDArr\" value=\"" + indexDataPage.BuyerUserID + "\" />";        myJsVal += "</td>";        myJsVal += " <td>" + indexDataPage.ActivityID + "</td>";        myJsVal += " <td><a href=\"../ActivityPage/ActivityDetail?AID=" + indexDataPage.ActivityID + "\" target=\"_blank\">" + indexDataPageExtra.AcTitle + "</a></td>";        myJsVal += " <td>" + indexDataPage.LinkMobile + "</td>";        myJsVal += " <td><img src=\"" + indexDataPage.HeaderImg + "\" style=\"width: 30px; height:30px; border-radius:20px; margin-right: 5px;\" />" + indexDataPage.UserNick + "</td>";        myJsVal += " <td>" + _IsChecked + "</td>";        myJsVal += " <td>" + indexDataPage.CheckedDate + "</td>";        myJsVal += " <td>" + indexDataPage.WriteDate + " <font color=\"red\">" + _WriteDateDay + "</font></td>";        myJsVal += " <td>";        if (indexDataPageExtra.IsJoinCheck == "false" && indexDataPage.IsChecked == "false") {            myJsVal += "<button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-warning am-round\" onclick=\"chgActivityJoined('" + indexDataPage.AcJoinID + "', '" + indexDataPage.ActivityID + "')\">已参与</button>";
        }        else if (indexDataPageExtra.IsJoinCheck == "true" && indexDataPage.IsChecked == "false") {            myJsVal += "<button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-warning am-round\" onclick=\"window.location.href='../ActivityPage/ActivityJoinVerify?AID=" + indexDataPage.ActivityID + "'\">参与验证</button>";
