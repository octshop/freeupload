...
//AjaxURL
var mAjaxUrl = "../ShopAjax/GoodsAll";
...
function initSearchWhereArr(pPageOrderName, pIsOnlyDiscount) {
    ...
    mSearchWhereArr = mShopID + "^" + pPageOrderName + "^" + pIsOnlyDiscount
...
function chgTab(pTabNum, pIsReload) {
    ...
    {
        initSearchWhereArr("GroupMsgCount", "false");
        $(_navItemLabelArr[5]).addClass("nav-item-current");
    }
    else if (pTabNum == "8") //秒杀
    {
        initSearchWhereArr("SecKill", "false");
