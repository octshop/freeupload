...
//AjaxURL
var mAjaxUrl = "../Trading/BuyerIntegralDividend";
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        var _ExtraDataHref = "#";
        if (indexDataPage.InExType == "TransDividend") {
            _ExtraDataHref = "../UserGoodsShopPage/UserAccountDetail?UID=" + indexDataPage.ExtraData;
        }
        else if (indexDataPage.InExType == "AllDividend") {
            _ExtraDataHref = "../TradingPage/OrderDetail?OID=" + indexDataPage.ExtraData;
            if (indexDataPageExtra.ExtraDataName == "扫码") {
                _ExtraDataHref = "javascript:void(0)";
            }
        }
