...
{
    public class VipAjaxController : Controller
    {
        /// <summary>
        /// 会员系统首页 余额，积分
        /// </summary>
        ...
        public string AggreOrder()
        {
            ...
            if (_exeType == "1")
            {
                ...
                _dicPost.Add("PageCurrent", PageCurrent);
                _dicPost.Add("BuyerUserID", _loginBuyerUserID);
                _dicPost.Add("OrderStatus", "支付成功");
                _dicPost.Add("IsPaySuccess", "true");
                _dicPost.Add("IsLoadField", "Shop");
                _dicPost.Add("IsLock", "false");

                string _jsonBack = BusiApiHttpNS.BusiApiHttp.httpApiAjaxPage(WebAppConfig.ApiUrl_T_AggregateOrderMsg, "T_AggregateOrderMsg", "1", _dicPost);
                return _jsonBack;
            }
