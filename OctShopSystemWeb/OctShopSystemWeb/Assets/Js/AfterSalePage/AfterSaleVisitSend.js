...
/**-----定义公共变量------**/
//AjaxURL
var mAjaxUrl = "../AfterSale/AfterSaleSendGoods";
...
var searchContent = function () {
    ...
    //翻页所用
    var strPOSTSePush = {
        "ApplyID": ApplyID_se, "SendType": SendType_se, "ExpressName": ExpressName_se,
        "ExpressNumber": ExpressNumber_se, "SendShopMan": SendShopMan_se, "SendTelNumber": SendTelNumber_se, "WriteDate": WriteDate_se,
    };
    //将对象添加到分类对象中
...
/**
 * 得到售后方式名称
 * @param {any} pSendType 发货类型 (Express 快递售后， Visiting 上门服务)
 */
function getSendTypeName(pSendType) {

    if (pSendType == "Express") {
        return "快递售后";
    }
    else if (pSendType == "Visiting") {
        return "上门服务";
    }
