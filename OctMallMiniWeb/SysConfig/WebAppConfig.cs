...
public class WebAppConfig
{
    ...
    /// 微信小程序Http请求的Key
    /// </summary>
    public static string HttpSecretKeyMini = ConfigHelper.getAppSettingsValue("HttpSecretKeyMini").Trim();

    /// <summary>
    ///微信小程序Http请求的Key 多少秒后过期
    /// </summary>
    public static int HttpSecretKeyMiniOverTimeSecond = Convert.ToInt32(ConfigHelper.getAppSettingsValue("HttpSecretKeyMiniOverTimeSecond"));

    /// <summary>
    /// AppID(小程序ID)
    /// </summary>
    public static string WxMiniAppID = ConfigHelper.getAppSettingsValue("WxMiniAppID").Trim();

    /// <summary>
    /// AppSecret(小程序密钥)
    /// </summary>
    public static string WxMiniAppSecret = ConfigHelper.getAppSettingsValue("WxMiniAppSecret").Trim();

    /// <summary>
    /// AppID(小程序ID) 是否可以获取 用户手机号
    /// </summary>
    public static string WxMiniIsGetUserMobile = ConfigHelper.getAppSettingsValue("WxMiniIsGetUserMobile").Trim();

    /// <summary>
    /// AppID(小程序ID) 是否可以由H5网页跳转到小程序页 UrlScheme
    /// </summary>
    public static string MiniUrlSchemeIsGet = ConfigHelper.getAppSettingsValue("MiniUrlSchemeIsGet").Trim();
    ...
    //【小程序-用户注册登录】
    public static string ApiUrl_UGS_MiniLoginRegUserAccount = OctUserGoodsShopSystemWeb_ApiDomain + "/User/MiniLoginRegUserAccount";
    ...
    //-------------------【微信支付】相关---------------------------//
    //【微信小程序支付】
    public static string ApiUrl_TAC_GetWxMiniUnifiedOrderResult = OctThirdApiCallSystemWeb_ApiDomain + "/WxPay/GetWxMiniUnifiedOrderResult";
    //【微信小程序支付 - 非商城订单模式】
    public static string ApiUrl_TAC_GetWxMiniUnifiedNoOrderResult = OctThirdApiCallSystemWeb_ApiDomain + "/WxPay/GetWxMiniUnifiedNoOrderResult";
    //【微信/支付宝模拟支付】
    public static string ApiUrl_TAC_SimulatePay = OctThirdApiCallSystemWeb_ApiDomain + "/PayPubAjax/SimulatePay";
