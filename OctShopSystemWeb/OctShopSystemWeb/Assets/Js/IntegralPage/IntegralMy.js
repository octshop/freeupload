...
//AjaxURL
var mAjaxUrl = "../Integral/IntegralMy";
...
function jsonToXhtml(pJsonObject) {
    ...
    var myJsVal = "";    //循环构造    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        //收支类型（  Recharge充积分 Appraise 商品评价 BuyGoods 购买商品）
        var _InExType = "" + indexDataPageExtra.InExTypeName + "(" + indexDataPage.InExType +")";
        //if (indexDataPage.InExType == "BuyGoods") {
        //    _InExType = "购买商品(BuyGoods)";
        //}
        //else if (indexDataPage.InExType == "Recharge") {
        //    _InExType = "充积分(Recharge)";
        //}
