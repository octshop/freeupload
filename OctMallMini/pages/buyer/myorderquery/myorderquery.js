// pages/buyer/myorderquery/myorderquery.js
//==============引入相关的Js文件========//
...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      octContentMarginTop: _navbarHeight + 53
    });
  ...
  searchContent: function () {
    //初始化搜索条件
    this.initSearchWhereArr(this.data.searchKey);
    //加载数据分页 - 网络请求
    this.numberPage();
  },
   ...
   * 初始化搜索条件
   */
  initSearchWhereArr: function (pSearchKey = "") {
    mSearchWhereArr = pSearchKey; //this.data.shopID + "^" + pPageOrderName + "^" + pIsOnlyDiscount
  },
  /**
   * 加载数据分页 - 网络请求
   * @param {*} pPageCurrent 
