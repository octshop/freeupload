...
//AjaxURL
var mAjaxUrl = "../Goods/ShopAppraise";
...
var searchContent = function () {
    ...
    var ConformityScore = $("#ConformityScore_se").val().trim();
    var AttitudeScore = $("#AttitudeScore_se").val().trim();
    var ExpressScore = $("#ExpressScore_se").val().trim();
    var DeliverymanScore = $("#DeliverymanScore_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "OrderID": OrderID, "ConformityScore": ConformityScore,
        "AttitudeScore": AttitudeScore, "ExpressScore": ExpressScore, "DeliverymanScore": DeliverymanScore, "WriteDate": WriteDate,
...
function countShopAppraiseMsg() {
    ...
    $.ajax({
        ...
        dataType: "html",
        success: function (reTxt, status, xhr) {
            console.log("统计店铺各评价信息=" + reTxt);
            if (reTxt != "") {
                var _jsonReTxt = JSON.parse(reTxt);

                //赋值
                $("#AvgShopScoreB").html(_jsonReTxt.AvgShopScore + "分");
                $("#AvgConformityScoreB").html(_jsonReTxt.AvgConformityScore + "分");
                $("#AvgAttitudeScoreB").html(_jsonReTxt.AvgAttitudeScore + "分");
                $("#AvgExpressScoreB").html(_jsonReTxt.AvgExpressScore + "分");
                $("#AvgDeliverymanScoreB").html(_jsonReTxt.AvgDeliverymanScore + "分");
