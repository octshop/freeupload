...
//AjaxURL
var mAjaxUrl = "../ThirdApiCall/SmsSendMsg";
...
var searchContent = function () {
    ...
    var SmsSendID_se = $("#SmsSendID_se").val().trim();
    var ToMobileNumbers_se = $("#ToMobileNumbers_se").val().trim();
    var SmsType_se = $("#SmsType_se").val().trim();
    var SmsTemplateCode_se = $("#SmsTemplateCode_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "SmsSendID_se": SmsSendID_se, "ToMobileNumbers": ToMobileNumbers_se, "SmsType": SmsType_se,
        "SmsTemplateCode": SmsTemplateCode_se, "IsVerify": IsVerify_se, "IsLock": IsLock_se, "WriteDate": WriteDate_se
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";
        myJsVal += " <td>" + indexDataPage.SmsSendID + "</td>";
        myJsVal += " <td>" + indexDataPage.ToMobileNumbers + "</td>";
        myJsVal += " <td>" + indexDataPageExtra.SmsTypeName + "(" + indexDataPage.SmsType + ")</td>";
        myJsVal += " <td>" + indexDataPage.SmsTemplateCode + "</td>";
        myJsVal += " <td>" + indexDataPageExtra.IsVerifyName + "</td>";
        myJsVal += " <td>";
 ...
 */
function delSmsSendMsgMonthAgo(pMonthNumAgo) {
