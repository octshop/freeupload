...
//AjaxURL
var mAjaxUrl = "../Trading/ShopIncomeExpense";
...
var searchContent = function () {
    ...
    //翻页所用
    var strPOSTSePush = {
        "InExMsgID": InExMsgID_se, "ShopUserID": ShopUserID_se, "IncomeSum": IncomeSum_se,
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        if (indexDataPage.InExType == "Order" || indexDataPage.InExType == "Refund") {
            ...
            _ExtraDataHref = "../TradingPage/AggreOrderDetail?AOID=" + indexDataPage.ExtraData;
        }
        else if (indexDataPage.InExType == "Settle") {
            _ExtraDataHref = "../TradingPage/SettleDetail?SAID=" + indexDataPage.ExtraData;
        }

        myJsVal += "<tr>";
        myJsVal += " <td>" + indexDataPage.InExMsgID + "</td>";
        myJsVal += " <td>" + indexDataPage.ShopUserID + "<i style=\"color: #939393;display: block\"><a href=\"../UserGoodsShopPage/ShopMsgDetail?UserID=" + indexDataPage.ShopUserID + "\" target=\"_blank\">" + indexDataPageExtra.ShopName + "</a></i></td>";
