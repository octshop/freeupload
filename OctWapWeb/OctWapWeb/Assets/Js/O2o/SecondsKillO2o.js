...
//AjaxURL
var mAjaxUrl = "../O2oAjax/SecondsKill";
...
function loadSecKillGoodsType() {
    ...
    $.ajax({
        type: "POST",
        url: "../MallAjax/SecondsKill?rnd=" + Math.random(),
        data: dataPOST,
        dataType: "html",
...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        if (dataPage.GoodsTitle.length > 34) {
            dataPage.GoodsTitle = dataPage.GoodsTitle.substring(0, 34) + "...";
        }
        //---计算价格----//
        var _maxDiscount = 10;
        ...
        myJsVal += " </div>";
        myJsVal += " <div class=\"goods-item-msg\" style=\"width:100%\">";
        ...
        myJsVal += "     </div>";
        myJsVal += "     <div class=\"goods-item-price\" style=\"width:100%\">";
        myJsVal += "        <div>";
        myJsVal += "             <b>&#165; " + formatNumberDotDigit(_goodsPrice, 2) + "</b>";
        myJsVal += "             <span>&#165; " + formatNumberDotDigit(dataPage.MarketPrice, 2) + "</span>";
        myJsVal += "         </div>";
