...
//AjaxURL
var mAjaxUrl = "../MallAjax/SearchGoodsResultO2o";
        ...
        success: function (reTxt, status, xhr) {
            ...
            if (reTxt != "") {
                ...
                if (_jsonReTxt != undefined && _jsonReTxt != null) {
                    ...
                    //显示代码插入前台
                    $("#AllWhereType1").html(xhtmlAllWhereType2);
                }
...
function addSearchHistoryGoods() {
    ...
    //构造POST参数
    var dataPOST = {
        "Type": "2", "SearchContent": mSearchKeyword, "BuyerUserID": mBuyerUserID, "IsEntity": "true",
    };
