...
//AjaxURL
var mAjaxUrl = "../Trading/SettleAggregateOrderMsg";
...
var searchContent = function () {
    ...
    //翻页所用
    var strPOSTSePush = {
        "SettleID": SettleID_se, "AggregateOrderID": AggregateOrderID_se, "ShopUserID": ShopUserID_se,
        "BillNumber": BillNumber_se, "OrderStatus": OrderStatus_se, "PayWay": PayWay_se, "PayTime": PayTime_se,
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";
        myJsVal += " <td><a href=\"../TradingPage/SettleDetail?SAID=" + indexDataPage.SettleID + "\" target=\"_blank\">" + indexDataPage.SettleID + "</a><i style=\"color: #939393;display: block\"><a href=\"../TradingPage/AggreOrderDetail?AOID=" + indexDataPage.AggregateOrderID + "\" target=\"_blank\">" + indexDataPage.AggregateOrderID + "</a></i></td>";
        ...
        myJsVal += " </td>";
        myJsVal += " <td>";
        myJsVal += "<input type=\"button\" class=\"table-btn am-btn am-btn-default am-btn-xs am-text-secondary am-round\" value=\"详细\" onclick=\"window.open('../TradingPage/AggreOrderDetail?AOID=" + indexDataPage.AggregateOrderID + "')\" />";
        myJsVal += " </td>";
        myJsVal += "</tr>";
