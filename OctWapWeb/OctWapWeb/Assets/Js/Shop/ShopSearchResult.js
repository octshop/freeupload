...
//AjaxURL
var mAjaxUrl = "../ShopAjax/ShopSearchResult";

var mShopID = ""; //店铺ID
var mBuyerUserID = ""; //买家UserID

var mSearchGoodsKey = ""; //商品搜索内容
...
$(function () {
    ...
    mSearchGoodsKey = $("#hidSearchContent").val().trim();
...
function addSearchHistoryGoods() {
    ...
    //构造POST参数
    var dataPOST = {
        "Type": "2", "SearchContent": mSearchGoodsKey, "BuyerUserID": mBuyerUserID,
    };
...
function initSearchWhereArr(pPageOrderName, pIsOnlyDiscount) {
    ...
    // mShopID + "^" + pPageOrderName + "^" + pIsOnlyDiscount + "^" + pSearchGoodsKey;

    mSearchWhereArr = mShopID + "^" + pPageOrderName + "^" + pIsOnlyDiscount + "^" + mSearchGoodsKey;
