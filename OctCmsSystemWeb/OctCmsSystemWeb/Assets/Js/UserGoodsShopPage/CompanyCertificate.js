...
//AjaxURL
var mAjaxUrl = "../UserGoodsShop/CompanyCertificate";
...
var searchContent = function () {
    ...
    var CertID_se = $("#CertID_se").val().trim();
    var CompanyID_se = $("#CompanyID_se").val().trim();
    var CertType_se = $("#CertType_se").val().trim();
    var UploadGuid_se = $("#UploadGuid_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "CertID": CertID_se, "CompanyID": CompanyID_se, "CertType": CertType_se,
        "UploadGuid": UploadGuid_se, "IsLock": IsLock_se, "WriteDate": WriteDate_se,
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";        myJsVal += "   <td><input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.CertID + "\" /></td>";        myJsVal += "   <td>" + indexDataPage.CertID +"</td>";        myJsVal += "   <td><a href=\"../UserGoodsShopPage/CompanyMsgDetail?CompanyID=" + indexDataPage.CompanyID + "\">" + indexDataPageExtra.CompanyName +"，[ " + indexDataPage.CompanyID +" ]</a></td>";        myJsVal += "   <td>" + indexDataPageExtra.CertTypeName +"，[ "+ indexDataPage.CertType +" ]</td>";        myJsVal += "   <td><a href=\"//" + indexDataPage.CertImg + "\" target=\"_blank\"><img style=\"width: 100px; margin: 5px;\" src=\"//" + indexDataPage.CertImg +"\" /></a></td>";        myJsVal += "   <td>" + indexDataPage.UploadGuid +"</td>";        myJsVal += "   <td>" + indexDataPage.WriteDate +"</td>";        myJsVal += "   <td>";        myJsVal += "       <button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-success am-round\" onclick=\"delMsg(" + indexDataPage.CertID +")\"><span class=\"am-icon-trash-o\"></span></button>";        myJsVal += "   </td>";        myJsVal += "</tr>";
