...
//AjaxURL
var mAjaxUrl = "../AfterSaleAccCus/PlatformSysMsg";
...
var searchContent = function () {
    ...
    var PSysMsgID_se = $("#PSysMsgID_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "PSysMsgID": PSysMsgID_se, "SysMsgType": SysMsgType_se,
        "MsgTitle": MsgTitle_se, "MsgContent": MsgContent_se, "ExtraData": ExtraData_se, "IsRead": IsRead_se, "WriteDate": WriteDate_se
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";
        myJsVal += " <td>" + indexDataPage.PSysMsgID + "</td>";
 ...
 */
function delPlatformSysMsgMonthAgo(pMonthNumAgo) {
