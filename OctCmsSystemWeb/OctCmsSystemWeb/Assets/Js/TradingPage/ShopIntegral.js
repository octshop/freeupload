...
//AjaxURL
var mAjaxUrl = "../Trading/ShopIntegral";
...
var searchContent = function () {
    ...
    //翻页所用
    var strPOSTSePush = {
        "IntegralID": IntegralID_se, "ShopUserID": ShopUserID_se, "IncomeSum": IncomeSum_se,
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        //额外数据链接
        var _ExtraDataHref = "";
        if (indexDataPage.InExType == "PstOrderPay") {
            _ExtraDataHref = "../TradingPage/PresentOrderDetail?POID=" + indexDataPage.ExtraData;
        }
        else if (indexDataPage.InExType == "Recharge") {
