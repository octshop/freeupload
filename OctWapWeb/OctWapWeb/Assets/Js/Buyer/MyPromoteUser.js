...
/**-----定义公共变量------**/
var mAjaxUrl = "../BuyerAjax/MyPromoteUser";
...
function pageSuccess(curPageDataJson) {
    ...
    $("#PromoteUserCountB").html("分享的好友(" + mCurPageDataJson.RecordSum + "位)");
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        myJsVal += " <div class=\"promote-user-item\">";
        myJsVal += " <div>";
        myJsVal += "     <img src=\"" + dataPage.HeaderImg + "\" />";
        myJsVal += " </div>";
        myJsVal += " <div class=\"promote-user-name\">";
        myJsVal += "     " + dataPage.UserNick + " <i>" + dataPage.WriteDate.substring(0, dataPage.WriteDate.indexOf(" ")) + "</i>";
        myJsVal += " </div>";
        myJsVal += "</div>";
