...
<body>
    <form id="form1" runat="server">
        ...
        <!--剪裁预览图片的大小-->
        <input type="hidden" id="hidWidthCropPre" value="970" runat="server" />
        <input type="hidden" id="hidHideCropPre" value="550" runat="server" />

        <!--剪裁区域的大小-->
        <input type="hidden" id="hidCropZoomWidth" value="970" runat="server" />
        <input type="hidden" id="hidCropZoomHeight" value="550" runat="server" />
