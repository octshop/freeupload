...
Page({
  ...
  initBillNumberOrderMsg: function () {
    ...
    //正式发送Http请求
    mHttp.postHttp(app.apiURLData.payApi_PaySuRedirect, _dataPOST, _jsonReTxt => {
      ...
      //设置公共变量值
      this.setData({
        initBillNumberOrderMsg_Data: _jsonReTxt,
        payOrderCount: _jsonReTxt.BillNumberOrderMsgList.length,
        orderIdSingle: _jsonReTxt.BillNumberOrderMsgList[0].OrderID,
      });
