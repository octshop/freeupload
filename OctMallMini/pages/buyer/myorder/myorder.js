...
Page({
  ...
  onLoad: function (options) {
    ...
    //获取传递的参数
    var _orderStatus = options.OS;
    if (_orderStatus == undefined || _orderStatus == null) {
      _orderStatus = "";
    }
    var _currentTabNum = "0"
    if (_orderStatus == "待付款") {
      _currentTabNum = "1";
    } else if (_orderStatus == "待发货") {
      _currentTabNum = "2";
    } else if (_orderStatus == "待收货") {
      _currentTabNum = "3";
    } else if (_orderStatus == "待评价") {
      _currentTabNum = "4";
    }
