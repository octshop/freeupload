...
function jsonToXhtml(pJsonObject) {
    ...
    var myJsVal = "";    //循环构造    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";        myJsVal += "  <td><input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.ActivityID + "\" /></td>";        myJsVal += " <td>" + indexDataPage.ActivityID + "</td>";        myJsVal += " <td><a href=\"../ActivityPage/ActivityDetail?AID=" + indexDataPage.ActivityID + "\" target=\"_blank\">" + indexDataPage.AcTitle + "</a></td>";        myJsVal += " <td>" + _AcType + "</td>";        myJsVal += " <td>" + _LimitJoinType + "</td>";        myJsVal += " <td>" + _IsJoinPause + "</td>";        myJsVal += " <td>" + _IsCheck + "</td>";        myJsVal += " <td>" + indexDataPage.StartDate + " <font color=\"red\">" + _StartDay + "</font></td>";        myJsVal += " <td>" + indexDataPage.EndDate + " <font color=\"red\">" + _EndDay + "</font></td>";        myJsVal += " <td>";        myJsVal += " <button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-success am-round\" onclick=\"createQRCodeImg('" + indexDataPage.ActivityID + "', '" + indexDataPage.AcTitle + "')\">二维码</button>";        myJsVal += " <button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-secondary am-round\" onclick=\"window.location.href='../ActivityPage/ActivityEdit?AID=" + indexDataPage.ActivityID + "'\">编辑</button>";        if (indexDataPage.IsJoinCheck == "true") {            myJsVal += "<button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-warning am-round\" onclick=\"window.location.href='../ActivityPage/ActivityJoinVerify?AID=" + indexDataPage.ActivityID + "'\">参与验证</button>";
        }        myJsVal += " </td>";        myJsVal += "</tr>";
