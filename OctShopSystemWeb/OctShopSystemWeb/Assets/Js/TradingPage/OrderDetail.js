...
function xhtmlGiftMsgList(pOrderGiftJsonArr) {
    ...
    for (var i = 0; i < pOrderGiftJsonArr.length; i++) {
        ...
        myJsVal += "<div>";        myJsVal += " <span>";        myJsVal += "     <a href=\"" + mOctWapWebAddrDomain + "/Mall/PagePreMobileIframe?LoadPreURL=" + mOctWapWebAddrDomain + "/Goods/GiftDetail?GIID=" + pOrderGiftJsonArr[i].GiftID + "\" target=\"_blank\">" + pOrderGiftJsonArr[i].GiftName + "</a>";        myJsVal += " </span>";        myJsVal += " <span>";        myJsVal += "     &#165; " + pOrderGiftJsonArr[i].GiftPrice + " &nbsp; x " + pOrderGiftJsonArr[i].GiftNum + "";        myJsVal += " </span>";        myJsVal += "</div>";
    }
    return myJsVal;}
