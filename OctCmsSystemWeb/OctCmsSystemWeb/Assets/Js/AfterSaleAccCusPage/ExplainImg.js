...
//AjaxURL
var mAjaxUrl = "../FileUpload/ExplainImg";
...
var mPageType = 3; //数据分页请求类别 Type值
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "       <input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.ImgKeyGuid + "\" /><a href=\"//" + indexDataPage.ServerDomain + "/" + indexDataPage.ImgPath + "\" target=\"_blank\">上传ID-" + indexDataPage.UploadID + "</a>";
        myJsVal += "   </div>";
        myJsVal += "   <input type=\"button\" data-clipboard-text=\"//" + indexDataPage.ServerDomain + "/" + indexDataPage.ImgPath + "\" class=\"img-class btn-copy am-btn am-block am-radius am-btn-xs am-btn-primary\" value=\"复制图片地址\" />";
        myJsVal += "</li>";
