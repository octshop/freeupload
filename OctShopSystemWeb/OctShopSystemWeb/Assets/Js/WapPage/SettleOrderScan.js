...
function initSearchContent() {
    ...
    $("#SearchKeyContentTxt").keydown(function (event) {
...
function searchContent() {
    ...
    mSearchKeyContent = $("#SearchKeyContentTxt").val().trim();
    ...
    if (mSearchKeyContent == "" || mSearchKeyContent == undefined || mSearchKeyContent == null) {
        mSearchKeyContent = "";
    }
...
function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
    ...
    var dataGET = {
        ...
        "PageCurrent": pageNum,
        "SettleID": mSettleID,
        "AggregateOrderID": mSearchKeyContent,
        "PayTime": mSearchKeyDate,
    };
    //正式发送GET请求
    $.ajax({
        type: "POST",
...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        myJsVal += "<li class=\"settle-msg-li\" onclick=\"window.location.href='../WapPage/OrderAggreDetail?AOID=" + dataPage.AggregateOrderID + "'\">";
        myJsVal += " <div class=\"settle-top\">";
        myJsVal += "     <div>结算ID:<b>" + dataPage.SettleID + "</b>扫码订单ID:<b>" + dataPage.AggregateOrderID + "</b>金额:<b>&#165;" + dataPage.OrderPrice + "</b></div>";
        myJsVal += "     <div>";
        ...
        myJsVal += "     </div>";
        myJsVal += "     <div>";
        myJsVal += "         <span>抽成金额：</span><b>&#165;" + dataPage.CommissionMoney + "</b>";
        myJsVal += "         <span class=\"right-span\">结算金额：</span><b>&#165;" + (parseFloat(dataPage.OrderPrice) - parseFloat(dataPage.CommissionMoney)) + "</b>";
        myJsVal += "     </div>";
        myJsVal += " </div>";
        ...
        myJsVal += "     </div>";
        myJsVal += "     <div>";
        myJsVal += "         支付时间：<b>" + formatDataTimeShortDate(dataPage.PayTime) + "</b>";
        myJsVal += "     </div>";
        myJsVal += " </div>";
        myJsVal += "</li>";
