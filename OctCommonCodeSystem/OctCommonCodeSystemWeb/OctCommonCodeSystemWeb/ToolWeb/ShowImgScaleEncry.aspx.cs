...
public partial class PubWeb_ShowImgScaleEncry : System.Web.UI.Page
{
    //------------------前台【加密】调用方法---------------//
    //<img id=\"CertPreImg_1\" src=\"../PubWeb/ShowImgScaleEncry.aspx?FilePathFrom=" + EncryptionClass.RSAEncryptSection("",_modelTtCompensateMsg.CertificateImg1).Replace("+", "%2B") + "&LimitWidthNum=246&LimitHeightNum=170\" />
    //------------------前台【加密】调用方法---------------//

    protected void Page_Load(object sender, EventArgs e)
    {
        string FilePathFrom = EncryptionClass.RSADecryptSection("", Request["FilePathFrom"].ToString().Trim().Replace("%2B", "+"));
