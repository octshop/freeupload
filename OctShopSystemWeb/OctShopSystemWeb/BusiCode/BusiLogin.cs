...
namespace OctShopSystemWeb
{
    public class BusiLogin
    {
        ...
        /// <param name="pLoginPwdNoSha1">登录密码 没有SHA1加密</param>
        /// <returns></returns>
        public static bool setLoginCookie(string pUserID, string pLoginPwdNoSha1)
        {
            string _loginCookieMsg = pUserID + "^" + EncryptionClassNS.EncryptionClass.GetSHA1(pLoginPwdNoSha1);
            //加密存储
        ...
        /// <summary>
        /// 设置用户登录Cookie --SHA1加密后的LoginPwd
        /// </summary>
        /// <param name="pUserID">用户UserID</param>
        /// <param name="pLoginPwdSha1">SHA1加密后的LoginPwd</param>
        /// <returns></returns>
        public static bool setLoginCookieLoginPwdSha1(string pUserID, string pLoginPwdNoSha1)
        {
            string _loginCookieMsg = pUserID + "^" + pLoginPwdNoSha1;
            //加密存储
            PublicClass.setCookieValueRSAEncrypt("OctUserLoginCookie", _loginCookieMsg);
        ...
        /// </summary>
        /// <returns></returns>
        public static string[] getLoginCookieUserIDAndLoginPwdSha1()
        {
        ...
        public static string getLoginUserID()
        {
            ...
            string[] _userLoginCookieArr = BusiLogin.getLoginCookieUserIDAndLoginPwdSha1();
        ...
        public static string isLoginRetrunUserID()
        {
            ...
            _dicPost.Add("BuyerUserID", _userLoginCookieArr[0]); //买家或商家的UserID
            _dicPost.Add("IsOpenShop", "true"); //开通了店铺的买家为商家
        ...
        /// <returns></returns>
        public static string isLoginPageRetrunUserID(string pBackUrl = "", string pNoLoginRedirectURL = "~/LoginPage/Index")
        {
            //判断用户登录是否正确
