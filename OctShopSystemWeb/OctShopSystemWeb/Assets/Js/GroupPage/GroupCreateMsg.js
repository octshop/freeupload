...
/**-----定义公共变量------**/
//AjaxURL
var mAjaxUrl = "../Group/GroupCreateMsg";
...
var searchContent = function () {
    ...
    var strPOSTSePush = {
        ...
        "IsFinish": IsFinish_se, "IsPaySuccess": IsPaySuccess_se, "IsRefund": IsRefund_se, "OverTimeDate": OverTimeDate_se, "WriteDate": WriteDate_se,
    };
    //将对象添加到分类对象中
 ...
 */
function manualGroupFinishSingle(pGroupID, pBuyerUserID) {

    if (pGroupID == "" || pBuyerUserID == "") {
        return;
    }
    ...
    confirmWinWidth("确定要手动成团吗？", function () {
        ...
        //构造POST参数
        var dataPOST = {
            "Type": "2", "GroupID": pGroupID, "BuyerUserID": pBuyerUserID,
        };
