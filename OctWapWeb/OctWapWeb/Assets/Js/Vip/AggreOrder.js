...
/**-----定义公共变量------**/
var mAjaxUrl = "../VipAjax/AggreOrder";
...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        myJsVal += "<li>";
        myJsVal += " <div class=\"aggreorder-item-left\">";
        myJsVal += "     <div>";

        if (dataPageExtra.ShopHeaderImg != "" && dataPageExtra.ShopHeaderImg != null && dataPageExtra.ShopHeaderImg != undefined) {
            myJsVal += "<img src=\"//" + dataPageExtra.ShopHeaderImg + "\" />";
        }
        else {
            myJsVal += "<img src=\"../Assets/Imgs/Icon/pay_wellat.png\" />";
        }

        myJsVal += "     </div>";
        myJsVal += "     <div>";
        myJsVal += "         <div class=\"shop-name\">" + dataPageExtra.ShopName + "</div>";
        myJsVal += "         <div class=\"pay-time\"> " + dataPage.PayTime + "</div>";
        myJsVal += "     </div>";
        myJsVal += " </div>";
        myJsVal += " <div class=\"aggreorder-item-right\">";
        myJsVal += "     <div>";
        myJsVal += "         <b>-" + dataPage.OrderPrice + "</b>";
        myJsVal += "         <i>" + dataPageExtra.PayWayName + "</i>";
        myJsVal += "     </div>";
        myJsVal += " </div>";
        myJsVal += "</li>";
