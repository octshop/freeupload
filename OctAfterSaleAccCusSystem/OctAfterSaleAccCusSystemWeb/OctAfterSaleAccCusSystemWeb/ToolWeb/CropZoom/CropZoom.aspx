...
<body>
    <form id="form1" runat="server">
        ...
        <input type="hidden" id="hidHideCropPre" value="900" runat="server" />

        <!--剪裁区域的大小-->
        <input type="hidden" id="hidCropZoomWidth" value="1370" runat="server" />
        <input type="hidden" id="hidCropZoomHeight" value="900" runat="server" />
        ...
        <div class="crop-main">
            ...
            <div class="send_data">
               ...
               <div class="send_data_right">确认</div> 
            </div>
