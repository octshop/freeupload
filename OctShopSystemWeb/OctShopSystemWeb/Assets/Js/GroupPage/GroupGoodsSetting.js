...
function jsonToXhtml(pJsonObject) {
    ...
    var myJsVal = "";    //循环构造    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<tr>";        myJsVal += "  <td><input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.GroupSettingID + "\" /></td>";        myJsVal += " <td><a href=\"" + mOctWapWebAddrDomain + "/Goods/GroupDetailPreMobileIframe?GID=" + indexDataPage.GoodsID + "\" target=\"_blank\">" + indexDataPage.GoodsID + "<br />" + indexDataPageExtra.GoodsTitle + "</a></td>";        myJsVal += " <td>" + indexDataPage.GroupDiscount + "折</td>";        myJsVal += " <td>" + indexDataPage.GroupPersonNum + "</td>";        myJsVal += " <td>" + indexDataPage.GroupSaleNum + "</td>";        myJsVal += " <td>" + indexDataPage.OverTimeDay + "</td>";        myJsVal += " <td>";        myJsVal += _checkStatu;        myJsVal += "<div style=\"color:gray;font-size:10px;\">" + indexDataPage.CheckReason + "</div>";        myJsVal += " </td>";        myJsVal += " <td>" + _isUnSale + "</td>";        myJsVal += " <td>" + indexDataPage.WriteDate + "</td>";        myJsVal += " <td>";        if (indexDataPage.IsUnSale == "true") {            myJsVal += "<button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-secondary am-round\" onclick=\"tglGroupGoodsSettingIsUnSaleArr('" + indexDataPage.GroupSettingID + "', 'false')\">上架</button>";
        }        else {            myJsVal += "<button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-secondary am-round\" onclick=\"tglGroupGoodsSettingIsUnSaleArr('" + indexDataPage.GroupSettingID + "', 'true')\">下架</button>";
        }        myJsVal += "     <button class=\"table-btn am-btn am-btn-default am-btn-xs am-text-secondary am-round\" onclick=\"openEditWin('" + indexDataPage.GroupSettingID + "','" + indexDataPage.GoodsID + "')\">修改</button>";        myJsVal += " </td>";        myJsVal += "</tr>";    }    //alert(myJsVal);    //-----分页控制条显示代码-------//    var pageBarXhtml = "";    pageBarXhtml += " <li><a href=\"javascript:void(0)\" onclick=\"PrePage()\">«</a></li>";    pageBarXhtml += " <li><a href=\"javascript:void(0)\" onclick=\"NumberPage('1')\">1</a></li>";    pageBarXhtml += "  <li><span>...</span></li>";    if ((intPageCurrent - 2) > 0) {
