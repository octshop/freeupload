...
//AjaxURL
var mAjaxUrl = "../Trading/BuyerIntegral";
...
var searchContent = function () {
    ...
    var IntegralID_se = $("#IntegralID_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "IntegralID": IntegralID_se, "BuyerUserID": BuyerUserID_se, "IncomeSum": IncomeSum_se,
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        var _ExtraDataHref = "#";
        if (indexDataPage.InExType == "BuyGoods" || indexDataPage.InExType == "AppraiseImg" || indexDataPage.InExType == "Appraise") {
            _ExtraDataHref = "../UserGoodsShopPage/GooGoodsDetail?GID=" + indexDataPage.ExtraData;
        }
        else if (indexDataPage.InExType == "PstOrderPay") {
            _ExtraDataHref = "../TradingPage/PresentOrderDetail?POID=" + indexDataPage.ExtraData;
        }
        else if (indexDataPage.InExType == "Order") {
        ...
        myJsVal += "<tr>";
        myJsVal += " <td>" + indexDataPage.IntegralID + "</td>";
