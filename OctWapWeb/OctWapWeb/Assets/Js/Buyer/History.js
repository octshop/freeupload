...
/**-----定义公共变量------**/
var mAjaxUrl = "../BuyerAjax/BuyerBrowseHistory";
...
        var dataPage = dataPageArr[i];        var dataPageExtra = dataPageExtraArr[i];        if (_BrowserDate != dataPageExtra.BrowserDate) {            myJsVal += " <li class=\"history-title\">";            myJsVal += "     <b>" + dataPageExtra.BrowserDate + "</b>";            myJsVal += " </li>";
        }        myJsVal += " <li onclick=\"window.location.href='../Goods/GoodsDetail?GID=" + dataPage.GoodsID + "'\">";        myJsVal += "     <div class=\"history-item-left\">";        myJsVal += "         <a href=\"#\">";        myJsVal += "             <img src=\"//" + dataPageExtra.GoodsCoverImgPath + "\" />";        myJsVal += "         </a>";        myJsVal += "     </div>";        myJsVal += "     <div class=\"history-item-right\">";        myJsVal += "         <div class=\"history-item-top\">";        myJsVal += "" + dataPageExtra.GoodsTitle + "";        myJsVal += "         </div>";        myJsVal += "         <div class=\"history-item-mid\">";        myJsVal += "             销量：" + dataPageExtra.SaleCount + "，评价：" + dataPageExtra.CountGoodsAppraise + "";        myJsVal += "         </div>";        myJsVal += "         <div class=\"history-item-bottom\">";        myJsVal += "             <div>";        myJsVal += "  <b>&#165;" + dataPageExtra.DefaulLowPrice + "</b>";        myJsVal += "             </div>";        myJsVal += "             <div class=\"btn-list\">";        myJsVal += "  <input type=\"button\" class=\"btn-same\" value=\"找相似\" onclick=\"findSameGoods('" + dataPageExtra.GoodsTypeID + "', '" + dataPageExtra.IsEntityGoodsType + "')\" />";        myJsVal += "  <div class=\"btn-scart\"><img src=\"../Assets/Imgs/Icon/buyer_scart.png\" /></div>";        myJsVal += "             </div>";        myJsVal += "         </div>";        myJsVal += "     </div>";        myJsVal += " </li>";        _BrowserDate = dataPageExtra.BrowserDate;    }
