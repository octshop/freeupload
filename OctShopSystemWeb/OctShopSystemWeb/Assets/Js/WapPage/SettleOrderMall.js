...
function getListDataFromNet(pageNum, pageSize, successCallback, errorCallback) {
    ...
    var dataGET = {
        ...
        "PageCurrent": pageNum,
        "SettleID": mSettleID,
        "OrderID": mSearchKeyContent,
        "FinishTime": mSearchKeyDate,
    };
    //正式发送GET请求
    $.ajax({
        type: "POST",
...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        myJsVal += "     <div>结算ID:<b>" + dataPage.SettleID + "</b> 订单ID:<b>" + dataPage.OrderID + "</b> 金额:<b>&#165;" + dataPage.OrderPrice + "</b></div>";
        myJsVal += "     <div>";
        ...
        myJsVal += "     </div>";
        myJsVal += "     <div>";
        myJsVal += "         完成时间：<b>" + formatDataTimeShortDate(dataPage.FinishTime) + "</b>";
        myJsVal += "     </div>";
        myJsVal += " </div>";
        myJsVal += "</li>";
