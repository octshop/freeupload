 ...
 */
function formatDataTimeShortDate(pChatDateTime) {

    if (pChatDateTime == "" || pChatDateTime == null | pChatDateTime == undefined) {
        return "";
    }
    ...
    var _formatDateTime = yearStr + "-" + monthStr + "-" + dateStr;
 ...
 * @param {any} url
 */
function openNewWindowNoIntercept(url) {
...
/**
 * 得到当前的域名地址URL - http://192.168.3.10:1000
 * */
function getCurrentDomainURL() {
    var _currentDomainUrl = window.location.protocol + "//" + window.location.host; //   返回https://mp.csdn.net
