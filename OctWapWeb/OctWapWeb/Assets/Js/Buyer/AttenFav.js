...
/**-----定义公共变量------**/
var mAjaxUrl = "../BuyerAjax/BuyerFocusFav";

//搜索条件
var mSearchKey = "goods";
...
        var dataPage = dataPageArr[i];        var dataPageExtra = dataPageExtraArr[i];        if (dataPage.FocusFavType == "goods") {            myJsVal += " <li onclick=\"window.location.href='../Goods/GoodsDetail?GID=" + dataPage.GoodsID + "'\">";            myJsVal += " <div class=\"use-item-left\">";            myJsVal += "     <a href=\"#\">";            myJsVal += "         <img src=\"//" + dataPageExtra.GoodsCoverImgPath + "\" />";            myJsVal += "     </a>";            myJsVal += " </div>";            myJsVal += " <div class=\"use-item-right\">";            myJsVal += "     <div class=\"use-item-top\">";            myJsVal += "" + dataPageExtra.GoodsTitle + "";            myJsVal += "     </div>";            myJsVal += "     <div class=\"use-item-mid\">";            myJsVal += "         销量：" + dataPageExtra.SaleCount + "，评价：" + dataPageExtra.CountGoodsAppraise + "";            myJsVal += "     </div>";            myJsVal += "     <div class=\"use-item-bottom\">";            myJsVal += "         <b>&#165;" + dataPageExtra.DefaulLowPrice + "</b>";            myJsVal += "         <input type=\"button\" class=\"btn-use\" value=\"找相似\" onclick=\"findSameGoods('" + dataPageExtra.GoodsTypeID + "', '" + dataPageExtra.IsEntityGoodsType + "')\" />";            myJsVal += "     </div>";            myJsVal += " </div>";            myJsVal += "</li>";
        }        else if (dataPage.FocusFavType == "shop") {            if (dataPageExtra.MajorGoods.length > 41) {                dataPageExtra.MajorGoods = dataPageExtra.MajorGoods.substring(0, 40);
            }
            myJsVal += "<li class=\"use-shop-item\" onclick=\"window.location.href='../Shop/Index?SID=" + dataPage.ShopID + "'\">";            myJsVal += "  <div class=\"use-item-left\">";            myJsVal += "      <a href=\"#\">";            myJsVal += "          <img src=\"//" + dataPageExtra.ShopHeaderImg + "\" />";            myJsVal += "      </a>";            myJsVal += "  </div>";            myJsVal += "  <div class=\"use-item-right\">";            myJsVal += "      <div class=\"use-item-top\">";            myJsVal += "" + dataPageExtra.ShopName + "";            myJsVal += "      </div>";            myJsVal += "      <div class=\"use-item-mid\">";            myJsVal += "" + dataPageExtra.MajorGoods + "";            myJsVal += "      </div>";            myJsVal += "      <div class=\"use-item-bottom\">";            myJsVal += "          <b>" + dataPageExtra.CountFavShop + "人关注，评分：" + dataPageExtra.AvgAppraiseScore + "</b>";            myJsVal += "      </div>";            myJsVal += "  </div>";            myJsVal += "</li>";        }    }
...
/**
 * 切换选项卡
 * @param {any} pTabType 选项卡内容 [ goods  shop ]
 */
function chgTab(pTabType) {
 ...
 * 找相似的商品
 * */
function findSameGoods(pGoodsTypeID, pIsEntityGoodsType) {

    //alert("pIsEntityGoodsType=" + pIsEntityGoodsType);

    if (pIsEntityGoodsType == "true") {
        window.location.href = "../O2o/GoodsType?GTID=" + pGoodsTypeID;
    }
    else if (pIsEntityGoodsType == "false") {
        window.location.href = "../Mall/GoodsTypeListDetail?GTID=" + pGoodsTypeID;
    }
...
function countAllFavMsg() {
    ...
    $.ajax({
        ...
        dataType: "html",
        success: function (reTxt, status, xhr) {
            console.log("统计买家所有的收藏信息=" + reTxt);

            if (reTxt != "") {
                var _jsonReTxt = JSON.parse(reTxt);

                $("#CountFavGoods").html(_jsonReTxt.CountFavGoods);
                $("#CountFavShop").html(_jsonReTxt.CountFavShop);
