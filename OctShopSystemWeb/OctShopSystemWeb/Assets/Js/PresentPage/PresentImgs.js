...
//AjaxURL
var mAjaxUrl = "../Present/PresentImgs";
...
function jsonToXhtml(pJsonObject) {
    ...
    var myJsVal = "";    //循环构造    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += "<li class=\"img-item\">";        myJsVal += "   <div class=\"img-div\">";        myJsVal += "       <a href=\"//" + indexDataPage.ImgURL + "\" target=\"_blank\"><img src=\"//" + _domainAndImgPathArr[0] + "/ToolWeb/ShowImgScale.aspx?FilePathFrom=" + _domainAndImgPathArr[1] + "&LimitWidthNum=160&LimitHeightNum=140\" /></a>";        myJsVal += "   </div>";        myJsVal += "   <div class=\"btn-img\">";        myJsVal += "       <input type=\"checkbox\" name=\"SelCbItem\" id=\"SelCbItem_" + indexDataPage.PresentImgID + "\" /><a href=\"" + mOctWapWeb_AddrDomain + "/Present/PresentDetailPreMobileIframe?PID=" + indexDataPage.PresentID +"\" target=\"_blank\">礼品ID-" + indexDataPage.PresentID + "</a>";        myJsVal += "   </div>";        myJsVal += "   <input type=\"button\" data-clipboard-text=\"//" + indexDataPage.ImgURL + "\" class=\"img-class btn-copy am-btn am-block am-radius am-btn-xs am-btn-primary\" value=\"复制照片地址\" />";        myJsVal += "</li>";    }    //alert(myJsVal);    //-----分页控制条显示代码-------//    var pageBarXhtml = "";    pageBarXhtml += " <li><a href=\"javascript:void(0)\" onclick=\"PrePage()\">«</a></li>";    pageBarXhtml += " <li><a href=\"javascript:void(0)\" onclick=\"NumberPage('1')\">1</a></li>";    pageBarXhtml += "  <li><span>...</span></li>";    if ((intPageCurrent - 2) > 0) {
...
function delMsgArr() {
    ...
    //构造POST参数
    var dataPOST = {
        "Type": "2", "PresentImgIDArr": MsgIDArr,
    };
