...
{
    public class O2oApiController : Controller
    {
        /// <summary>
        /// 商城首页 O2o
        /// </summary>
        ...
        public string Index()
        {
            ...
            if (_exeType == "1")
            {
                ...
                string SelCityRegionArrCookie = PublicClass.FilterRequestTrimNoConvert("SelCityRegionArrCookie"); //BusiWebCookie.getSelCityRegionArrCookie();
            ...
            else if (_exeType == "3") //加载推荐商家与商品信息 (首页显示)
            {
                ...
                {
                    SelCityRegionCodeArr = PublicClass.FilterRequestTrimNoConvert("SelCityRegionCodeArr"); //BusiWebCookie.getSelCityRegionCodeArrCookie();
                }
