...
/**-----定义公共变量------**/
//AjaxURL
var mAjaxUrl = "../Trading/ShopIntegralRecharge";
...
var searchContent = function () {
    ...
    var BillNumberRhg_se = $("#BillNumberRhg_se").val().trim();
    var RechargePrice_se = $("#RechargePrice_se").val().trim();
    ...
    //翻页所用
    var strPOSTSePush = {
        "RechargeID": RechargeID_se, "BillNumberRhg": BillNumberRhg_se, "RechargePrice": RechargePrice_se, "RechargeMemo": RechargeMemo_se, "ShopUserID": ShopUserID_se, "IsPaySuccess": IsPaySuccess_se, "WriteDate": WriteDate_se,
    };
    //将对象添加到分类对象中
...
function jsonToXhtml(pJsonObject) {
    ...
    for (var i = 0; i < json.DataPage.length; i++) {
        ...
        myJsVal += " <td>" + indexDataPage.BillNumberRhg + "</td>";
        myJsVal += " <td>" + indexDataPage.RechargePrice + "</td>";
