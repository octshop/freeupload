...
function pageSuccess(curPageDataJson) {
    ...
    for (var i = 0; i < dataPageArr.length; i++) {
        ...
        if (dataPage.AcType == "OffLine") {
            myJsVal += "<span class=\"user-joined-span\">距: 1.3KM</span>";
        }
        ...
        if (dataPageExtra.LimitJoinTypeName != "不限制") {
            myJsVal += "<span class=\"user-joined-span\">" + dataPageExtra.LimitJoinTypeName + "</span>";
        }
